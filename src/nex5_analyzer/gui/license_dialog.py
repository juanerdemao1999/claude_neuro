...
from ..licensing import LicenseManager, LicenseValidationResult
...
class LicenseActivationDialog(QDialog):
    def __init__(
        ...
        *,
        ...
        subtitle = QLabel("请把本机机器码发给软件提供方，拿到密钥后粘贴到下方或导入密钥文件。")
        ...
        save_machine_button.setProperty("variant", "secondary")
        ...
        self.key_edit.setPlaceholderText("请粘贴软件提供方发来的密钥，或点击“导入密钥文件”。")
        ...
        exit_button.setProperty("variant", "secondary")
    ...
    def _handle_activation_result(self, result: LicenseValidationResult) -> None:
        ...
        if result.valid:
            ...
            QMessageBox.information(self, "激活成功", f"软件已激活。\n客户：{customer_name}")
            self.accept()
            return
